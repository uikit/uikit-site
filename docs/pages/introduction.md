...
Add the compiled and minified CSS and JavaScript to the `<head>` tag of your HTML5 document. Also include the UIkit icon library. For your basic setup, that's it.
