...
<div>
            ...
            <div class="uk-child-width-1-4@m uk-child-width-1-2@s" uk-grid>
                ...
                <div>
                    ...
                    <div class="uk-inline tm-box-shadow-medium uk-transition-toggle">
                        ...
                        <a class="tm-overlay-default uk-position-cover uk-transition-fade" href="#modal-copper-hill" uk-toggle></a>
                    </div>
                ...
                <div>
                    ...
                    <div class="uk-inline tm-box-shadow-medium uk-transition-toggle">
                        ...
                        <a class="tm-overlay-default uk-position-cover uk-transition-fade" href="#modal-sonic" uk-toggle></a>
                    </div>
                ...
                <div>
                    ...
                    <div class="uk-inline tm-box-shadow-medium uk-transition-toggle">
                        ...
                        <a class="tm-overlay-default uk-position-cover uk-transition-fade" href="#modal-fjord" uk-toggle></a>
                    </div>
                ...
                <div>
                    ...
                    <div class="uk-inline tm-box-shadow-medium uk-transition-toggle">
                        ...
                        <a class="tm-overlay-default uk-position-cover uk-transition-fade" href="#modal-joline" uk-toggle></a>
                    </div>
                ...
                <div>
                    ...
                    <div class="uk-inline tm-box-shadow-medium uk-transition-toggle">
                        <img src="images/pro/style-max.jpg" alt="Max Style">
                          <a class="tm-overlay-default uk-position-cover uk-transition-fade" href="#modal-max" uk-toggle></a>
                    </div>
                ...
                <div>
                    ...
                    <div class="uk-inline tm-box-shadow-medium uk-transition-toggle">
                        ...
                        <a class="tm-overlay-default uk-position-cover uk-transition-fade" href="#modal-horizon" uk-toggle></a>
                    </div>
                ...
                <div>
                    ...
                    <div class="uk-inline tm-box-shadow-medium uk-transition-toggle">
                        ...
                        <a class="tm-overlay-default uk-position-cover uk-transition-fade" href="#modal-fuse" uk-toggle></a>
                    </div>
            ...
            <div class="uk-child-width-1-5@m uk-child-width-1-3@s uk-child-width-1-2" uk-grid>
                ...
                <div>
                    ...
                    <div class="uk-inline tm-box-shadow-medium uk-transition-toggle">
                        ...
                        <a class="tm-overlay-default uk-position-cover uk-transition-fade" href="#modal-horizon-overview" uk-toggle></a>
                    </div>
                ...
                <div>
                    ...
                    <div class="uk-inline tm-box-shadow-medium uk-transition-toggle">
                        ...
                        <a class="tm-overlay-default uk-position-cover uk-transition-fade" href="#modal-sonic-location" uk-toggle></a>
                    </div>
                ...
                <div>
                    ...
                    <div class="uk-inline tm-box-shadow-medium uk-transition-toggle">
                        ...
                        <a class="tm-overlay-default uk-position-cover uk-transition-fade" href="#modal-joline-case-study" uk-toggle></a>
                    </div>
                ...
                <div>
                    ...
                    <div class="uk-inline tm-box-shadow-medium uk-transition-toggle">
                        ...
                        <a class="tm-overlay-default uk-position-cover uk-transition-fade" href="#modal-fjord-resources" uk-toggle></a>
                    </div>
                ...
                <div>
                    ...
                    <div class="uk-inline tm-box-shadow-medium uk-transition-toggle">
                        ...
                        <a class="tm-overlay-default uk-position-cover uk-transition-fade" href="#modal-copper-hill-lunch" uk-toggle></a>
                    </div>
                ...
                <div>
                    ...
                    <div class="uk-inline tm-box-shadow-medium uk-transition-toggle">
                        ...
                        <a class="tm-overlay-default uk-position-cover uk-transition-fade" href="#modal-sonic-speakers" uk-toggle></a>
                    </div>
                ...
                <div>
                    ...
                    <div class="uk-inline tm-box-shadow-medium uk-transition-toggle">
                        ...
                        <a class="tm-overlay-default uk-position-cover uk-transition-fade" href="#modal-horizon-products" uk-toggle></a>
                    </div>
                ...
                <div>
                    ...
                    <div class="uk-inline tm-box-shadow-medium uk-transition-toggle">
                        ...
                        <a class="tm-overlay-default uk-position-cover uk-transition-fade" href="#modal-joline-about" uk-toggle></a>
                    </div>
    ...
    <div id="modal-copper-hill" class="uk-modal-full" uk-modal>
        <div class="uk-modal-dialog tm-modal-dialog uk-flex uk-flex-column" uk-height-viewport>
            ...
            <div class="tm-modal-body uk-flex-1">
                <iframe class="uk-width-1-1 uk-height-1-1 tm-box-shadow-modal" src="https://demo.yootheme.com/themes/wordpress/2017/copper-hill/" ></iframe>
            </div>
        </div>
    </div>

    <div id="modal-sonic" class="uk-modal-full" uk-modal>
        <div class="uk-modal-dialog tm-modal-dialog uk-flex uk-flex-column" uk-height-viewport>
            <button class="uk-modal-close-full tm-modal-close-full uk-close-large" type="button" uk-close></button>
            <div class="tm-modal-header">
            ...
            <div class="tm-modal-body uk-flex-1">
                <iframe class="uk-width-1-1 uk-height-1-1 tm-box-shadow-modal" src="https://demo.yootheme.com/themes/wordpress/2017/sonic/" ></iframe>
            </div>
        </div>
    </div>

    <div id="modal-fjord" class="uk-modal-full" uk-modal>
        <div class="uk-modal-dialog tm-modal-dialog uk-flex uk-flex-column" uk-height-viewport>
            <button class="uk-modal-close-full tm-modal-close-full uk-close-large" type="button" uk-close></button>
            <div class="tm-modal-header">
    ...
    <div id="modal-joline" class="uk-modal-full" uk-modal>
        <div class="uk-modal-dialog tm-modal-dialog uk-flex uk-flex-column" uk-height-viewport>
            <button class="uk-modal-close-full tm-modal-close-full uk-close-large" type="button" uk-close></button>
            <div class="tm-modal-header">
            ...
            <div class="tm-modal-body uk-flex-1">
                <iframe class="uk-width-1-1 uk-height-1-1 tm-box-shadow-modal" src="https://demo.yootheme.com/themes/wordpress/2017/joline/" ></iframe>
            </div>
        </div>
    </div>

    <div id="modal-max" class="uk-modal-full" uk-modal>
        <div class="uk-modal-dialog tm-modal-dialog uk-flex uk-flex-column" uk-height-viewport>
            <button class="uk-modal-close-full tm-modal-close-full uk-close-large" type="button" uk-close></button>
            <div class="tm-modal-header">
            ...
            <div class="tm-modal-body uk-flex-1">
                <iframe class="uk-width-1-1 uk-height-1-1 tm-box-shadow-modal" src="https://demo.yootheme.com/themes/wordpress/2016/max/" ></iframe>
            </div>
        </div>
    </div>

    <div id="modal-horizon" class="uk-modal-full" uk-modal>
        <div class="uk-modal-dialog tm-modal-dialog uk-flex uk-flex-column" uk-height-viewport>
            <button class="uk-modal-close-full tm-modal-close-full uk-close-large" type="button" uk-close></button>
            <div class="tm-modal-header">
            ...
            <div class="tm-modal-body uk-flex-1">
                <iframe class="uk-width-1-1 uk-height-1-1 tm-box-shadow-modal" src="https://demo.yootheme.com/themes/wordpress/2016/horizon/" ></iframe>
            </div>
        </div>
    </div>

    <div id="modal-fuse" class="uk-modal-full" uk-modal>
        <div class="uk-modal-dialog tm-modal-dialog uk-flex uk-flex-column" uk-height-viewport>
            <button class="uk-modal-close-full tm-modal-close-full uk-close-large" type="button" uk-close></button>
            <div class="tm-modal-header">
            ...
            <div class="tm-modal-body uk-flex-1">
                <iframe class="uk-width-1-1 uk-height-1-1 tm-box-shadow-modal" src="https://demo.yootheme.com/themes/wordpress/2016/fuse/" ></iframe>
            </div>
        </div>
    </div>

    <div id="modal-horizon-overview" class="uk-modal-full" uk-modal>
        <div class="uk-modal-dialog tm-modal-dialog uk-flex uk-flex-column" uk-height-viewport>
            <button class="uk-modal-close-full tm-modal-close-full uk-close-large" type="button" uk-close></button>
            <div class="tm-modal-header">
            ...
            <div class="tm-modal-body uk-flex-1">
                <iframe class="uk-width-1-1 uk-height-1-1 tm-box-shadow-modal" src="https://demo.yootheme.com/themes/wordpress/2016/horizon/?page_id=19" ></iframe>
            </div>
        </div>
    </div>

    <div id="modal-sonic-location" class="uk-modal-full" uk-modal>
        <div class="uk-modal-dialog tm-modal-dialog uk-flex uk-flex-column" uk-height-viewport>
            <button class="uk-modal-close-full tm-modal-close-full uk-close-large" type="button" uk-close></button>
            <div class="tm-modal-header">
            ...
            <div class="tm-modal-body uk-flex-1">
                <iframe class="uk-width-1-1 uk-height-1-1 tm-box-shadow-modal" src="https://demo.yootheme.com/themes/wordpress/2017/sonic/?page_id=22" ></iframe>
            </div>
        </div>
    </div>

    <div id="modal-joline-case-study" class="uk-modal-full" uk-modal>
        <div class="uk-modal-dialog tm-modal-dialog uk-flex uk-flex-column" uk-height-viewport>
            <button class="uk-modal-close-full tm-modal-close-full uk-close-large" type="button" uk-close></button>
            <div class="tm-modal-header">
            ...
            <div class="tm-modal-body uk-flex-1">
                <iframe class="uk-width-1-1 uk-height-1-1 tm-box-shadow-modal" src="https://demo.yootheme.com/themes/wordpress/2017/joline/?page_id=24" ></iframe>
            </div>
        </div>
    </div>

    <div id="modal-fjord-resources" class="uk-modal-full" uk-modal>
        <div class="uk-modal-dialog tm-modal-dialog uk-flex uk-flex-column" uk-height-viewport>
            <button class="uk-modal-close-full tm-modal-close-full uk-close-large" type="button" uk-close></button>
            <div class="tm-modal-header">
            ...
            <div class="tm-modal-body uk-flex-1">
                <iframe class="uk-width-1-1 uk-height-1-1 tm-box-shadow-modal" src="https://demo.yootheme.com/themes/wordpress/2017/fjord/?page_id=21" ></iframe>
            </div>
        </div>
    </div>

    <div id="modal-copper-hill-lunch" class="uk-modal-full" uk-modal>
        <div class="uk-modal-dialog tm-modal-dialog uk-flex uk-flex-column" uk-height-viewport>
            <button class="uk-modal-close-full tm-modal-close-full uk-close-large" type="button" uk-close></button>
            <div class="tm-modal-header">
            ...
            <div class="tm-modal-body uk-flex-1">
                <iframe class="uk-width-1-1 uk-height-1-1 tm-box-shadow-modal" src="https://demo.yootheme.com/themes/wordpress/2017/copper-hill/?page_id=28" ></iframe>
            </div>
        </div>
    </div>

    <div id="modal-sonic-speakers" class="uk-modal-full" uk-modal>
        <div class="uk-modal-dialog tm-modal-dialog uk-flex uk-flex-column" uk-height-viewport>
            <button class="uk-modal-close-full tm-modal-close-full uk-close-large" type="button" uk-close></button>
            <div class="tm-modal-header">
            ...
            <div class="tm-modal-body uk-flex-1">
                <iframe class="uk-width-1-1 uk-height-1-1 tm-box-shadow-modal" src="https://demo.yootheme.com/themes/wordpress/2017/sonic/?page_id=20" ></iframe>
            </div>
        </div>
    </div>

    <div id="modal-horizon-products" class="uk-modal-full" uk-modal>
        <div class="uk-modal-dialog tm-modal-dialog uk-flex uk-flex-column" uk-height-viewport>
            <button class="uk-modal-close-full tm-modal-close-full uk-close-large" type="button" uk-close></button>
            <div class="tm-modal-header">
            ...
            <div class="tm-modal-body uk-flex-1">
                <iframe class="uk-width-1-1 uk-height-1-1 tm-box-shadow-modal" src="https://demo.yootheme.com/themes/wordpress/2016/horizon/?page_id=13" ></iframe>
            </div>
        </div>
    </div>

    <div id="modal-joline-about" class="uk-modal-full" uk-modal>
        <div class="uk-modal-dialog tm-modal-dialog uk-flex uk-flex-column" uk-height-viewport>
            <button class="uk-modal-close-full tm-modal-close-full uk-close-large" type="button" uk-close></button>
            <div class="tm-modal-header">
            ...
            <div class="tm-modal-body uk-flex-1">
                <iframe class="uk-width-1-1 uk-height-1-1 tm-box-shadow-modal" src="https://demo.yootheme.com/themes/wordpress/2017/joline/?page_id=20" ></iframe>
            </div>
        </div>
    </div>
